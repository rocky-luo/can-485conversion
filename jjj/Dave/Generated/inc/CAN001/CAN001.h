...
/** This macro function resets the INIT & CCE bit of the CAN Node0 Control Register (NCR)
  ...
  *  @param[in] None
  */
/* Handle0 initialisation mode exit */
#ifdef CAN001_Handle0_NODE
#define CAN_NODE0_ENABLE
#define CAN_Handle0_NODE()  {\
							WR_REG(CAN001_Handle0_NODE->NCR, CAN_NODE_NCR_CCE_Msk, CAN_NODE_NCR_CCE_Pos, 0);\
							WR_REG(CAN001_Handle0_NODE->NCR, CAN_NODE_NCR_INIT_Msk, CAN_NODE_NCR_INIT_Pos, 0);\
							}
#endif
...
/** This macro function resets the INIT & CCE bit of the CAN Node1 Control Register (NCR)
  ...
  *  @param[in] None
  */
/* Handle1 initialisation mode exit */
#ifdef CAN001_Handle1_NODE
#define CAN_NODE1_ENABLE
#define CAN_Handle1_NODE()  {\
							WR_REG(CAN001_Handle1_NODE->NCR, CAN_NODE_NCR_CCE_Msk, CAN_NODE_NCR_CCE_Pos, 0);\
							WR_REG(CAN001_Handle1_NODE->NCR, CAN_NODE_NCR_INIT_Msk, CAN_NODE_NCR_INIT_Pos, 0);\
							}
#endif
...
/** This macro function resets the INIT & CCE bit of the CAN Node2 Control Register (NCR)
  ...
  *  @param[in] None
  */
/* Handle2 initialisation mode exit */
#ifdef CAN001_Handle2_NODE
#define CAN_NODE2_ENABLE
#define CAN_Handle2_NODE()    {\
							WR_REG(CAN001_Handle2_NODE->NCR, CAN_NODE_NCR_CCE_Msk, CAN_NODE_NCR_CCE_Pos, 0);\
							WR_REG(CAN001_Handle2_NODE->NCR, CAN_NODE_NCR_INIT_Msk, CAN_NODE_NCR_INIT_Pos, 0);\
							}
#endif
/**
 *@}
