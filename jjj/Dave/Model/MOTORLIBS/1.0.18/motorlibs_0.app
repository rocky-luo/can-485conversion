...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="MOTORLIBS" description="This is the motor library for &#xA; different library functions. It is &#xA;used by motor app.This app does not consume any HW &#xA; reqources,so do not use it standalone." mode="SHARABLE" URI="http://www.infineon.com/1.0.18/app/motorlibs/0">
  ...
  <provided xsi:type="ResourceModel:API" description="This is the function for PT1 Filter." URI="http://www.infineon.com/1.0.18/app/motorlibs/0/motorlibs_pt1controller" APIName="MOTORLIBS_PT1Controller">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <provided xsi:type="ResourceModel:API" description="This is the function for PI controller." URI="http://www.infineon.com/1.0.18/app/motorlibs/0/motorlibs_picontroller" APIName="MOTORLIBS_PIController">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
