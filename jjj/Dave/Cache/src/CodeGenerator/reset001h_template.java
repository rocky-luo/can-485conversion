...
public class reset001h_template
{
  ...
  protected final String TEXT_21 = NL + "   /** USB peripheral module */" + NL + "   PER2_USB = 0x20000080U,\t\t\t\t" + NL + "   /** EBU peripheral module */" + NL + "   PER3_EBU = 0x30000004U";
